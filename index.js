...
// let my_template_string =confirm(`my_name` ${.name_Kevin} `my_id` ${.id_2112} `my_address` ${.Memphis,TN);
// console.log("My name is kevin + My id is 2112 + My address is memphis, TN "):
